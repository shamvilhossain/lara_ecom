...
<form style=" padding:0px;margin:0px;" name="frmOrderAutoSubmit" method="post" >
		...
		<input type="hidden" name="item_name" value="laptop"> <!-- concate all product using loop(comma seperated) -->
		<input type="hidden" name="amount" value="1000"> <!-- grand total in doller -->
